...
function getHiveplotServers(){
    $.ajax({
	type: "GET",
	url: "/mysite/hiveplot/api/server/data",
	data: {},
	dataType: "json",
...
function getHiveplotTopology(){
    $.ajax({
	type: "GET",
	url: "/mysite/hiveplot/api/server/topology/data",
	data: {},
	dataType: "json",
	success: function(data) {
	    var json_data = eval(data);    
...
function getHiveplotServerTags(){
    $.ajax({
	type: "GET",
	url: "/mysite/hiveplot/api/server/tags/data",
	data: {},
	dataType: "json",
	success: function(data){
	    var json_data = eval(data);
...
d3.select('.zTitle').transition().delay(500).duration(1000).text('');
 ...
 $.ajax({
	type: "GET",
	url: "/mysite/hiveplot/api/server/process/data",
	data: {'id': server.id},
	dataType: "json",
	success: function(data)  {
	    var json_data = eval(data);
...
function getServerIdprocessDetail(dict){
    ...
    $.ajax({
	type: "GET",
	url: "/mysite/hiveplot/api/server/process/data/detail",
	data: {'uid': dict[0],	
},
	dataType: "json",
	success: function(data)  {
...
$('.main_content').css('height',(viewportHeight * .9));
